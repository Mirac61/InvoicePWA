    ...
    <div class="flex items-center gap-3 flex-wrap">
      <div
        ...
        <svg width="15" height="15" viewBox="0 0 15 15" fill="none" class="shrink-0">
          <circle cx="6.5" cy="6.5" r="4.5" stroke="#999" stroke-width="1.4" />p
          <path d="M10 10l3.5 3.5" stroke="#999" stroke-width="1.4" stroke-linecap="round" />
        </svg>
        <input v-model="search" placeholder="Name, E-Mail, Stadt…"
          ...
          <tr v-for="c in filtered" :key="c.id"
            ...
            <td class="px-4 py-3.5">
              <div class="flex items-center gap-2.5">
                ...
                <span class="font-semibold text-gray-900">{{ c.forename }} {{ c.surname }}</span>
              </div>
            </td>
            ...
            <td class="px-4 py-3.5">
              <span class="inline-block px-2.5 py-1 rounded-full text-xs font-semibold" :class="c.type === 'BUSINESS'
